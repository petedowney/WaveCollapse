...
if("${show_ref_output}" MATCHES "refs/remotes/v1.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/MikePopoloski/boost_unordered'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/petedowney/Documents/GitHub/WaveCollapse/_deps/boost_unordered-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/petedowney/Documents/GitHub/WaveCollapse/_deps/boost_unordered-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
