...
if("${show_ref_output}" MATCHES "refs/remotes/v4.1.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v4.1.0")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/petedowney/Documents/GitHub/WaveCollapse/cmake-build-default/_deps/raylib_cpp-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/petedowney/Documents/GitHub/WaveCollapse/cmake-build-default/_deps/raylib_cpp-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
